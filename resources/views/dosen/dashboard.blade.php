    ...
    <div style="width: 100%; height: 100%; position: relative; background: white">
        ...
        <div style="width: 1042.86px; height: 1340px; left: 199px; top: 294px; position: absolute">
            ...
            <a href="{{route('dosen.courses.create')}}">
              <div style="width: 390.77px; height: 64.31px; left: 850px; top: 0px; position: absolute; color: black; font-size: 40px; font-family: Poppins; font-weight: 400; word-wrap: break-word">
                New Course
              </div>
            </a>  
            ...
            @for ($i = 0; $i < $coursesCount; $i++)
                ...
                <a href="{{route('dosen.viewTask', $courses[$i]->id)}}" style="width: 277.61px; height: 38.26px; left: 144.09px; top: 446.12px; position: absolute; color: black; font-size: 24px; font-family: Poppins; font-weight: 400; word-wrap: break-word; text-decoration: none;">
                ...
                @elseif($i == 1)
                    ...
                    <a href="{{route('dosen.viewTask', $courses[$i]->id)}}" style="width: 258.88px; height: 38.26px; left: 629.30px; top: 446.12px; position: absolute; color: black; font-size: 24px; font-family: Poppins; font-weight: 400; word-wrap: break-word; text-decoration: none;">
                        <div>{{ $courses[$i]->name }}</div>
                    </a>    
                @elseif($i == 2)
                    ...
                    <a href="{{route('dosen.viewTask', $courses[$i]->id)}}" style="width: 238.53px; height: 38.26px; left: 153.86px; top: 834.45px; position: absolute; color: black; font-size: 24px; font-family: Poppins; font-weight: 400; word-wrap: break-word; text-decoration: none;">
                        <div>{{ $courses[$i]->name }}</div>
                    </a>   
                @endif
            @endfor
