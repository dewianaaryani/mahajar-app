    ...
    <div style="width: 100%; height: 100%; position: relative; background: white">
        ...
        @if($tasks->isNotEmpty())
            ...
            @for ($i = 0; $i < $tasksCount; $i++)
                <div class="course">
                    @if ($i == 0)
                        <a href="{{route('dosen.viewAssignments',$tasks[$i]->id)}}"><div name="1" style="width: 839px; height: 107px; left: 301px; top: 294px; position: absolute; background: #5271FF; border-radius: 20px"></div></a>
                    @elseif($i == 1)
                        <a href="{{route('dosen.viewAssignments',$tasks[$i]->id)}}"><div name="2" style="width: 839px; height: 107px; left: 301px; top: 458px; position: absolute; background: #5271FF; border-radius: 20px"></div></a>
                    @elseif($i == 2)
                        <a href="{{route('dosen.viewAssignments',$tasks[$i]->id)}}"><div name="3" style="width: 839px; height: 107px; left: 301px; top: 622px; position: absolute; background: #5271FF; border-radius: 20px"></div></a>
                    @elseif($i == 3)
                        <a href="{{route('dosen.viewAssignments',$tasks[$i]->id)}}"><div name="5" style="width: 839px; height: 107px; left: 301px; top: 786px; position: absolute; background: #5271FF; border-radius: 20px"></div></a>
                    @elseif($i == 4)
                        <a href="{{route('dosen.viewAssignments',$tasks[$i]->id)}}"><div name="6" style="width: 839px; height: 107px; left: 303px; top: 953px; position: absolute; background: #5271FF; border-radius: 20px"></div></a>
                    @elseif($i == 5)
                        <a href="{{route('dosen.viewAssignments',$tasks[$i]->id)}}"><div name="4" style="width: 839px; height: 107px; left: 301px; top: 1138px; position: absolute; background: #5271FF; border-radius: 20px"></div></a>
                    @elseif($i == 6)
                        <a href="{{route('dosen.viewAssignments',$tasks[$i]->id)}}"><div name="7" style="width: 839px; height: 107px; left: 301px; top: 1303px; position: absolute; background: #5271FF; border-radius: 20px"></div></a>
                    @elseif($i == 7)
                        <a href="{{route('dosen.viewAssignments',$tasks[$i]->id)}}"><div name="8" style="width: 839px; height: 107px; left: 303px; top: 1490px; position: absolute; background: #5271FF; border-radius: 20px"></div></a>
                    @endif           
                    <!-- Render each course -->
                </div>
            @endfor
        ...
        @endif
        <a href="{{route('dosen.tasks.create', $course)}}" style="width: 300.77px; height: 64.31px; left: 950px; top: 40px; position: absolute; color: #002C6E; font-size: 30px; font-family: Poppins; font-weight: 400; text-decoration: none">
            + New Tasks
        </a>
